...
% https://tex.stackexchange.com/questions/122190/patch-font-with-luatex
...
\title[Compilations reproductibles]{Compilations reproductibles}
\subtitle{Permettre le lien entre un binaire et sa source}
\author[Lunar]{%
   \texorpdfstring{
            \centering
            Lunar\\
