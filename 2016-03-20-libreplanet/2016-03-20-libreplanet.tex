...
\begin{frame}
 ...
 \begin{tikzpicture}[remember picture]
  \node[at=(current page.center)] {
   \includegraphics[width=0.82\paperwidth]{images/diffoscope_example_html.png}
  };
 \end{tikzpicture}
\end{frame}
...
\begin{frame}
 ...
 \end{itemize}
 \begin{tikzpicture}[remember picture,overlay]
  \node[shift={(-0.10\paperwidth, 0.18\paperheight)},at=(current page.south east)] {
...
\begin{frame}
 ...
 \end{itemize}
 \begin{tikzpicture}[remember picture,overlay]
  \node[shift={(-0.13\paperwidth, 0.1\paperheight)},at=(current page.south east)] {
...
\begin{frame}
 ...
 \end{itemize}
 \begin{tikzpicture}[remember picture,overlay]
  \node[shift={(-0.10\paperwidth, 0.2\paperheight)},at=(current page.south east)] {
