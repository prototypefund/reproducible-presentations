...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \item<2-3> \texttt{sudo apt-get install torbrowser-launcher}
  \item<3> Ask me anything! I do key signing too.
 \end{itemize}
\end{frame}
...
\begin{frame}
 ...
 \begin{itemize}
  \item 116 jenkins jobs running on 11 hosts
  ...
  \item \texttt{armhf}: 16 cores and 8 GB RAM on 5 systems, provided by vagrant@d.o.
 \end{itemize}
 \begin{center}
