...
\subtitle{we are not there yet -\\ though "just" achieving reproducible builds
\\ won't be enough}
\author[lamby \& h01ger]{%
   \texorpdfstring{
        \begin{columns}
...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \item Nearly two patches per day since Autumn 2014 on average!
 \end{itemize}
\end{frame}
...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \item How to get started?
   \begin{itemize}
    \item Talk to us here or on IRC or via mail.
