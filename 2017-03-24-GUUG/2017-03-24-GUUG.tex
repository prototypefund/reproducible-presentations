...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \item 15-20\% of the packages embed build-time pathes into generated files, evevn though these paths do not exist at runtime, nor do they exist in the source code.
