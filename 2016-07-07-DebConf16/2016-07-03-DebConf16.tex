...
\title[Reproducible Builds status update]{Reproducible Builds status update}
\author[Chris 'lamby' Lamb Holger 'h01ger' Levsen]{}
\institute[Debian]{}
\date[DebConf16]{%
 DebConf16 (Cape Town, SA)\\
 \small{2016-07-07}}
...
\begin{frame}[plain]
 ...
 \begin{tikzpicture}[remember picture,overlay]
  \node[shift={(-0.11\paperwidth, 0.2\paperheight)},at=(current page.south east)] {
    \includegraphics[height=0.2\paperheight]{images/Dc16_703x473.png}
  };
 \end{tikzpicture}
\end{frame}
 ...
 \begin{center}
  \begin{columns}
   ...
   \column{.30\linewidth}
    ...
    {Asheesh Laroia} \\
    {Ceridwen} \\
    \only<1>{Chris Lamb}\only<2>{{\color{debianred} Chris Lamb}} \\
    {Chris West} \\
    {Christoph Berg} \\
    {Daniel Kahn Gillmor} \\
    {Daniel Shahaf} \\
