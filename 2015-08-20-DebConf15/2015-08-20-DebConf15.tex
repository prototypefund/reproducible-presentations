...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \item \texttt{diffoscope} (formerly known as \texttt{debindiff})
...
\begin{frame}
 ...
 \begin{itemize}
  \item Testing:
   \begin{itemize}
    \item Requires \texttt{pbuilder}, custom config, the “reproducible” repository
