...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \item Used to be amd64 only, now also armhf, soon ppc64el too - more hardware wanted
...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \item In Debian, set according to the latest \texttt{debian/changelog} entry
 \end{itemize}
\end{frame}
 ...
 \begin{itemize}
  \item Testing:
   \begin{itemize}
    ...
    \item Needs the “reproducible” repository
    \item Documented on the wiki
    \item diffoscope is in \textit{unstable} and \textit{stretche}
   \end{itemize}
