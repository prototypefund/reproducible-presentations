...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \item Fedora user since 1984
  \item Fedora contributor since fedora.us
  \item Plattform lead at RedHat
  \item Day job since 8 years: Fedora
  \end{itemize}
...
\begin{frame}
 ...
 \item<3> And this still needs tools, infrastructure and policies to become
 ...
 \begin{center}
  \resizebox{0.9\textwidth}{!}{%
   \begin{tabular}{rl}
    ...
    \texttt{dennis@ausil.us} & \texttt{FIXM EFIX MEFI XMEF IXME} \\
