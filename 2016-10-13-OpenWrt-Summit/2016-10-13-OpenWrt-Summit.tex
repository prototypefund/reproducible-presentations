...
\title[Reproducible builds for OpenWrt]{Bit by bit identically reproducible
builds \\ for OpenWrt and LEDE}
\subtitle{Lightning talk \\
with probably still too much information \\
for 15 minutes…}
\author[h01ger and lynxis]{%
   \texorpdfstring{
            \centering
            Alexander 'lynxis' Couzens\\
            \href{mailto:lynxis@fe80.eu}{lynxis@fe80.eu}\\
...
\begin{frame}
 ...
 \begin{itemize}
  ...
  \item my talk "the Reproducible builds ecosystem" from FOSDEM 16
  \end{itemize}
\end{frame}
